        ...
        <div className="relative z-10 container mx-auto px-4 md:px-8 py-24 md:py-36">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button asChild variant="outline" className="border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground/10 font-body px-8 py-6 text-base">
